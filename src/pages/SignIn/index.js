 ...
 alignItems:'center'
    ...
    <Card
        ...
        >
          ...
          <Box marginBottom={5}>
               <Link component={RouterLink} to="/sign-up" style={{float:'left' , textDecoration: "none" }}>
                <Typography sx={{ color: "green" , padding:'2px'}}>
                  SIGN UP ?
                </Typography>
              </Link>
               <Button
                  onClick={forgotPasswordHandler}
                  sx={{ color: "green", textDecoration: "none" , float:'right'  }}
                >
                  forgotPassword?
                </Button>
          </Box>
